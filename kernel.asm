...
80106dbf:	eb 12                	jmp    80106dd3 <shm_open+0xe3>
...
80106dd1:	74 d9                	je     80106dac <shm_open+0xbc>
  if(shm_table.shm_pages[i].id == 0){
80106dd3:	8b 0a                	mov    (%edx),%ecx
80106dd5:	85 c9                	test   %ecx,%ecx
80106dd7:	75 ef                	jne    80106dc8 <shm_open+0xd8>
    shm_table.shm_pages[i].id = id;
80106dd9:	8d 34 40             	lea    (%eax,%eax,2),%esi
80106ddc:	c1 e6 02             	shl    $0x2,%esi
80106ddf:	89 9e f4 54 11 80    	mov    %ebx,-0x7feeab0c(%esi)
    shm_table.shm_pages[i].frame = kalloc();
80106de5:	e8 c6 b6 ff ff       	call   801024b0 <kalloc>
    memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106dea:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106df1:	00 
80106df2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106df9:	00 
    shm_table.shm_pages[i].refcnt = 1;
80106dfa:	c7 86 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%esi)
80106e01:	00 00 00 
    memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106e04:	89 04 24             	mov    %eax,(%esp)
    shm_table.shm_pages[i].frame = kalloc();
80106e07:	89 86 f8 54 11 80    	mov    %eax,-0x7feeab08(%esi)
    memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106e0d:	e8 7e d4 ff ff       	call   80104290 <memset>
    mappages(myproc()->pgdir, (char*) PGROUNDUP(myproc()->sz), PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106e12:	8b b6 f8 54 11 80    	mov    -0x7feeab08(%esi),%esi
80106e18:	e8 93 c8 ff ff       	call   801036b0 <myproc>
80106e1d:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106e23:	8b 18                	mov    (%eax),%ebx
80106e25:	e8 86 c8 ff ff       	call   801036b0 <myproc>
80106e2a:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e31:	00 
80106e32:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106e36:	81 c3 ff 0f 00 00    	add    $0xfff,%ebx
80106e3c:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106e42:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e49:	00 
80106e4a:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106e4e:	8b 40 04             	mov    0x4(%eax),%eax
80106e51:	89 04 24             	mov    %eax,(%esp)
80106e54:	e8 f7 f6 ff ff       	call   80106550 <mappages>
80106e59:	e9 21 ff ff ff       	jmp    80106d7f <shm_open+0x8f>
...
80106e76:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106e7b:	eb 0d                	jmp    80106e8a <shm_close+0x2a>
80106e7d:	8d 76 00             	lea    0x0(%esi),%esi
80106e80:	83 c0 0c             	add    $0xc,%eax
//Loop through all 64 pages to find the segment
for(i = 0; i < 64; i++){
80106e83:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106e88:	74 36                	je     80106ec0 <shm_close+0x60>
  if(shm_table.shm_pages[i].id == id){
80106e8a:	3b 18                	cmp    (%eax),%ebx
80106e8c:	75 f2                	jne    80106e80 <shm_close+0x20>
    //Decrease reference count
    shm_table.shm_pages[i].refcnt--;
80106e8e:	8b 48 08             	mov    0x8(%eax),%ecx
80106e91:	8d 51 ff             	lea    -0x1(%ecx),%edx
    //Cleat it if refcnt reaches 0
    if(shm_table.shm_pages[i].refcnt == 0){
80106e94:	85 d2                	test   %edx,%edx
    shm_table.shm_pages[i].refcnt--;
80106e96:	89 50 08             	mov    %edx,0x8(%eax)
    if(shm_table.shm_pages[i].refcnt == 0){
80106e99:	75 e5                	jne    80106e80 <shm_close+0x20>
      shm_table.shm_pages[i].id = 0;
80106e9b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106ea1:	83 c0 0c             	add    $0xc,%eax
      shm_table.shm_pages[i].frame = 0;
80106ea4:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
      shm_table.shm_pages[i].refcnt = 0;
80106eab:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
for(i = 0; i < 64; i++){
80106eb2:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106eb7:	75 d1                	jne    80106e8a <shm_close+0x2a>
